...
func main() {
	...
	case 3:
		runDay3(partNum, inputPath)
	case 4:
		runDay4(partNum, inputPath)
	default:
...
func runDay3(part int, inputPath string) {
	/* Run the specified part of day 3 */
	switch part {
	case 1:
		result, err := day3.Part1(inputPath)
		if err != nil {
			fmt.Printf("Error: %v\n", err)
			os.Exit(1)
		}
		fmt.Println(result)
	case 2:
		results, err := day3.Part2(inputPath)
		if err != nil {
			fmt.Printf("Error: %v\n", err)
			os.Exit(1)
		}
...
func runDay4(part int, inputPath string) {
	/* Run the specified part of day 4 */
	switch part {
	case 1:
		result, err := day4.Part1(inputPath)
		if err != nil {
			fmt.Printf("Error: %v\n", err)
			os.Exit(1)
		}
		fmt.Println(result)
	case 2:
		results, err := day4.Part2(inputPath)
		if err != nil {
			fmt.Printf("Error: %v\n", err)
			os.Exit(1)
		}
